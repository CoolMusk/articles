...
>  在《JavaScript高级程序设计（第三版）》中备注：实际上，DOM0级标准是不存在的；所谓的DOM0级只是历史上坐标中一个参照点而已。具体来说，DOM0级指的是 Internet Explorer 4.0 和Netscape Navigator 4.0 zui'chu'zhi'chi
<!--stackedit_data:
eyJoaXN0b3J5IjpbLTE2MTg2NTQ5MzRdfQ==
-->